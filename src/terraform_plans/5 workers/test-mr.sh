...
docker exec -d -w /go/worker worker1 /bin/sh -c "go run mrworker.go wc.so >> worker1_5.out"
if [ $? -eq 0 ]; then
...
docker exec -d -w /go/worker worker2 /bin/sh -c "go run mrworker.go wc.so >> worker2_5.out"
if [ $? -eq 0 ]; then
...
docker exec -d -w /go/worker worker3 /bin/sh -c "go run mrworker.go wc.so >> worker3_5.out"
if [ $? -eq 0 ]; then
...
docker exec -d -w /go/worker worker4 /bin/sh -c "go run mrworker.go wc.so >> worker4_5.out"
if [ $? -eq 0 ]; then
...
docker exec -d -w /go/worker worker5 /bin/sh -c "go run mrworker.go wc.so >> worker5_5.out"
if [ $? -eq 0 ]; then
